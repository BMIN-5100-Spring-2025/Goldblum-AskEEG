...
def create_synchrony_plots(results, fs, output_dir):
    ...
    Args:
        results (dict): Dictionary of results from analyze_synchrony_from_edf
        fs (float): Sampling frequency
    ...
    band_centers = [np.mean(results[band]["frequency_range"]) for band in band_names]
...
if __name__ == "__main__":
    ...
    # Run analysis
    analyze_synchrony_from_edf(input_path, output_dir, freq_bands)
